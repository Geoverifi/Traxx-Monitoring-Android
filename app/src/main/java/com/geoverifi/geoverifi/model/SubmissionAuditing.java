...
public class SubmissionAuditing implements Parcelable {
    ...
    public String get_trafficquantity() {
        return _traffic_quantity;
    }

    public void set_trafficquantity(String _traffic_quantity) {
        this._traffic_quantity = _traffic_quantity;
    }

    public String get_trafficspeed() {
        return _traffic_speed;
    }

    public void set_trafficspeed(String _traffic_speed) {
