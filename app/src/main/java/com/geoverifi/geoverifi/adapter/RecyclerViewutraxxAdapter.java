...
import com.geoverifi.geoverifi.DraftSubmissionsActivity;
import com.geoverifi.geoverifi.MainUtraxxActivity;
import com.geoverifi.geoverifi.MonitoringDataSubmission;
import com.geoverifi.geoverifi.OfflineDataActivity;
...
public class RecyclerViewutraxxAdapter extends RecyclerView.Adapter<RecyclerViewutraxxAdapter.MenuViewHolder> {
    List<Menu> menuList;
    Context context;
    Activity activity;
    String[] colors = {"#AB47BC", "#2196F3", "#FF9800", "#009688", "#795548"};

    public RecyclerViewutraxxAdapter(List<Menu> menuList, Context context, Activity activity){
