...
public class OfflineSubmissionsAdapater extends RecyclerView.Adapter<OfflineSubmissionsAdapater.MyViewHolder> {
    Context context;
    List<Submission> offlineList;
    public OfflineSubmissionsAdapater(Context context, List<Submission> offlineList){
