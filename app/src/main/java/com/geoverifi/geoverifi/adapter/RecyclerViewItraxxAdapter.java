...
import com.geoverifi.geoverifi.DraftSubmissionsAuditingActivity;
import com.geoverifi.geoverifi.MainItraxxActivity;
import com.geoverifi.geoverifi.MonitoringDataSubmissionAuditing;
import com.geoverifi.geoverifi.OfflineDataAuditingActivity;
...
public class RecyclerViewItraxxAdapter extends RecyclerView.Adapter<RecyclerViewItraxxAdapter.MenuViewHolder> {
    List<Menu> menuList;
    ...
    public RecyclerViewItraxxAdapter(List<Menu> menuList, Context context, Activity activity){
    ...
    public void onBindViewHolder(final MenuViewHolder holder, int position) {
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (slug){
                    case "sycn_data_action":
                        DataInitializer.getInstance(context, true).initialize();
                        break;

                    case "offline_data_action":
                        newActivity = OfflineDataAuditingActivity.class;
                        break;

                    case "draft_data_action":
                        newActivity = DraftSubmissionsAuditingActivity.class;
                        break;

                    case "enter_data_action":
                        newActivity = MonitoringDataSubmissionAuditing.class;
                        break;
