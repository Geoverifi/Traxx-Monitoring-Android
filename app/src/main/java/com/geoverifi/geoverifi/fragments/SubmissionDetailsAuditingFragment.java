 ...
 */
public class SubmissionDetailsAuditingFragment extends Fragment{
    ...
    public SubmissionDetailsAuditingFragment(){
    ...
    public static SubmissionDetailsAuditingFragment newInstance(SubmissionAuditing submission) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_submission_details_auditing, container, false);
//        this.submission = getArguments().getParcelable(ARG_SUBMISSION_DATA);
        ...
        TextView txtquality = (TextView) rootView.findViewById(R.id.media_trafficquantity);
        TextView txtspeed = (TextView) rootView.findViewById(R.id.media_trafficspeed);
        ...
        txtquality.setText(submission.get_trafficquantity());
        txtspeed.setText(submission.get_trafficspeed());
