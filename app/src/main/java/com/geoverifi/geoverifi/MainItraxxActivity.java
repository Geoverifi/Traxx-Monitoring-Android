...
import com.geoverifi.geoverifi.adapter.RecyclerViewItraxxAdapter;
...
public class MainItraxxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user.get_firstname() == null){
            startActivity(new Intent(MainItraxxActivity.this, LoginActivity.class));
            finish();
            return;
        }
        ...
        gps = new GPSTracker(MainItraxxActivity.this);
        ...
        getSupportActionBar().setTitle("iTraxx");
        ...
        menuList = db.MenuItraxx(usertype);
        Point size = new Point();
        getWindowManager().getDefaultDisplay().getSize(size);

        RecyclerViewItraxxAdapter adapter = new RecyclerViewItraxxAdapter(menuList, this, this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                Intent intent = new Intent(MainItraxxActivity.this, MainActivity.class);
                startActivity(intent);
                break;
            case R.id.logout:
                new AlertDialog.Builder(MainItraxxActivity.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                AccountManager accountManager = (AccountManager) MainItraxxActivity.this.getSystemService(ACCOUNT_SERVICE);
                                ...
                                Manager.getInstance(MainItraxxActivity.this).clear();
                                startActivity(new Intent(MainItraxxActivity.this, LoginActivity.class));
                                finish();
                            }
                        })
            ...
            case R.id.offline_data:
                startActivity(new Intent(this, OfflineDataAuditingActivity.class));
                break;
            ...
            case R.id.draft_submission:
                startActivity(new Intent(this, DraftSubmissionsAuditingActivity.class));
                break;
        }
        return true;
    }
    ...
    public void getBaseData(final DatabaseHandler db){
        ...
        JsonObjectRequest request = new JsonObjectRequest(url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MainItraxxActivity.this, "There was an error pulling data", Toast.LENGTH_LONG).show();
        ...
        JsonObjectRequest request = new JsonObjectRequest(urls, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    startActivity(new Intent(MainItraxxActivity.this, MainActivity.class));
                    finish();
