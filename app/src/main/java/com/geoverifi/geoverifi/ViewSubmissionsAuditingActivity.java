...
import com.geoverifi.geoverifi.adapter.SubmissionAuditingAdapter;
...
public class ViewSubmissionsAuditingActivity extends AppCompatActivity implements SearchView.OnQueryTextListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private SubmissionAuditingAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(user.get_user_type().equals("Admin") || user.get_user_type().equals("Super")){
            submissionList = db.allSubmissionsauditing();
        }else{
            submissionList = db.allSubmissionsauditing(user.get_id());
        }
        ...
        adapter = new SubmissionAuditingAdapter(this, submissionList);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                SubmissionAuditing submission = submissionList.get(position);
                Intent intent = new Intent(ViewSubmissionsAuditingActivity.this, SubmissionActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                startActivity(new Intent(ViewSubmissionsAuditingActivity.this, MainActivity.class));
                finish();
                break;
            case R.id.filter:
            ...
            case R.id.view_in_map:
                startActivity(new Intent(ViewSubmissionsAuditingActivity.this, ViewInMapActivity.class));
    ...
    void fetchData(){
        ...
        String url = Variables.BASE_URL + "API/getauditingSubmissions/" + user_id;
                    ...
                    if (response.getBoolean("status") == true){
                        ...
                        if(dataArray.length() != 0){
                            ...
                            for (int i = 0; i < dataArray.length(); i++) {
                                ...
                                submission.set_trafficquantity(submissionObj.getString("traffic_speed"));
