...
public class DataInitializer {
    ...
    public void setupMenu(){
        Menu menu = new Menu();
        menu.set_menu_title("Monitoring Data");
        ...
        menu = new Menu();
        menu.set_menu_title("Audit Data");
        menu.set_menu_icon(R.mipmap.ic_doc_add);
        menu.set_menu_slug("enter_audit_data_action");
        menu.set_menu_users("Admin, Staff Member, Super");
        db.addMenu(menu);

        menu = new Menu();
        menu.set_menu_title("Submissions");
        menu.set_menu_icon(R.mipmap.ic_view);
        menu.set_menu_slug("view_data_action");
        menu.set_menu_users("Admin, Staff Member, Super");
        db.addMenu(menu);
