...
public class MonitoringSubmissionPhotosAuditingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    ArrayList<SubmissionPhotoAuditing> submissionPhotos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitoring_submission_photos);
        ...
        String title = "Auditing Photos";
        if (structure.get_material_type().equals("Video")) {
            title = "Auditing Videos";
            empty_text.setText("No Video yet!");
        }
        getSupportActionBar().setTitle(title);
        submissionPhotos = db.getSubmissionAuditPhotos(submission_id);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case android.R.id.home:
                Intent intent = new Intent(MonitoringSubmissionPhotosAuditingActivity.this, MonitoringDataSubmissionAuditing.class);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.fab:
                Intent intent = new Intent(MonitoringSubmissionPhotosAuditingActivity.this, MonitoringSubmissionReviewAuditingActivity.class);
                intent.putExtra("submission_id", submission_id);
                intent.putExtra("data_type_sides", structure.get_type_sides());
    ...
    public class GridViewAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ...
            SubmissionPhotoAuditing photo = submissionPhotos.get(position);
        ...
        public void removeItem(int position){
            ...
            SubmissionPhotoAuditing upload = submissionPhotos.get(position);
            if(upload.getId() != 0) {
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            Uri photoURI = null;
            if (photoFile != null && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
                photoURI = FileProvider.getUriForFile(this,"com.geoverifi.geoverifi.provider", photoFile);
            }else if(photoFile != null && Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP){
    ...
    public void updateUI(){
        ...
        if (structure.get_material_type().equals("Photos")) {
            ...
            if (submissionPhotos.size() == 1){
                fab.setVisibility(View.VISIBLE);
                this.HIDE_MENU = 0;

                mVideoView.setVideoPath(submissionPhotos.get(0).getPath());
            }else{
                fab.setVisibility(View.GONE);
                this.HIDE_MENU = 1;
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            photo.setId(db.addSubmissionPhotoAuditing(photo));
